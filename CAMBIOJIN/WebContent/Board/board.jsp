...
//			e.preventDefault(); 기본이벤트제거
	...
	$(".mytr").on('click' , function(e) {
		...
		location.href = "boardUpdate.do?num="+num;
	});
...
<!-- 										style="color: black;"></a> -->
									...
									<%
										if (login != null && loginId.equals("admin")) {
									%>
									<th class="justfly-content-center text-center"><input
										class="inputbox" id="check${i.num}" type="checkbox" name="num"
										value="${i.num}"> <%
 	}
 %>
								</tr>
					...
					<ul class="pagination width50 fl-l">
						...
						<c:forEach begin="1" end="${boardcnt}" var="i">
							<li class="page-item"><a class="page-link"
								href="${path}/board.do?pageNum=${i}">${i}</a></li>
						</c:forEach>
						<li class="page-item"><a class="page-link" href="#">Next</a></li>
					</ul>
					<div class="width50 fl-r"
						style="margin: 20px 0; text-align: right;">
						<%
							if (login != null && login.equals("sce") && (loginId.equals("admin") != login.equals("sce"))) {
						%>
						<button type="button" class="btn btn-default"
							onclick="location.href='boardInsert.do';">글작성</button>
						<%
